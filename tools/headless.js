...
function runMeshChecks() {
  ...
  // Baseline bumped 124034 -> 124392: this was already stale before the
  // waterfall work (decorations stay OFF in run(), so no waterfall geometry
  // is involved) -- confirmed by running --mesh unmodified on this checkout.
